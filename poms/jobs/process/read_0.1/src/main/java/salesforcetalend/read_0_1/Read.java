...
public class Read implements TalendJob {
	static {System.setProperty("TalendJob.log", "Read.log");}
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_79rLIPBTEe-SqKhbb-NjMQ", "0.1");
...
public void tSalesforceConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tSalesforceConnection_1", "ea2aD0_");
...
org.talend.components.salesforce.SalesforceConnectionProperties props_tSalesforceConnection_1 =
        (org.talend.components.salesforce.SalesforceConnectionProperties) def_tSalesforceConnection_1.createRuntimeProperties();
 		                    ...
 		                    "");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:l6cWghhLP1PxLXvc9tnJ851n1BoGPf0SGaH5khJc6+xgmupCU/zvW1iUDam7rRXNqd8vmQ4="));
 		                        
 		                    props_tSalesforceConnection_1.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tSalesforceConnection_1.userPassword.setValue("userId",
 		                    "vudavidgo1@gmail.com");
 		                    
 		                        props_tSalesforceConnection_1.userPassword.setValue("password",
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FSd3GYreOKDWxqZ2BcAmdyRwq1BGp2SlPGc30IU+AkhwKfGl"));
...
public void tSalesforceInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tSalesforceInput_2", "CiBHtO_");
 ...
 */
	...
	s(currentComponent="tSalesforceInput_2");
		...
		int tos_count_tSalesforceInput_2 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tSalesforceInput_2", "tSalesforceInput_1", "tSalesforceInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
 ...
 */
	...
	s(currentComponent="tBufferOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tSalesforceInput_2","tSalesforceInput_1","tSalesforceInput","tBufferOutput_1","tBufferOutput_1","tBufferOutput"
 ...
 */
	...
	s(currentComponent="tBufferOutput_1");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tSalesforceInput_2","tSalesforceInput_1","tSalesforceInput","tBufferOutput_1","tBufferOutput_1","tBufferOutput","output")) {
						talendJobLogProcess(globalMap);
					}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Read' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-02-21T13:34:15.975897600Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Read.class.getClassLoader().getResourceAsStream("salesforcetalend/read_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Read.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     93977 characters generated by Talend Cloud Data Management Platform 
 *     on the 21. veljače 2025. u 14:34:15 CET
 ************************************************************************************************/