...
package salesforcetalend.read_0_1;
 ...
 * @status
 */
public class Read implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Read.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Read.class);
	...
	private final String jobName = "Read";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Read.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tSalesforceConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tSalesforceConnection_1", "T3A4E2_");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tSalesforceConnection_1.userPassword.setValue("securityKey",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:qrh80Vjx8+f2NQIFCGirr12YLTfvi8V5taqVt/8YBF2wIFPYaKV/CAxC6jwkESH9L9b1HL8="));
				...
				props_tSalesforceConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:6LnT96hbuEd4oGncxFk0xKQKugDsx/c/0k6ZBAbANPVjkx0T"));
...
// finally of generic
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_SALESFORCETALEND_Read = new byte[0];
		static byte[] commonByteArray_SALESFORCETALEND_Read = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCETALEND_Read.length) {
					if (length < 1024 && commonByteArray_SALESFORCETALEND_Read.length == 0) {
						commonByteArray_SALESFORCETALEND_Read = new byte[1024];
					} else {
						commonByteArray_SALESFORCETALEND_Read = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCETALEND_Read, 0, length);
				strReturn = new String(commonByteArray_SALESFORCETALEND_Read, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCETALEND_Read, 0, length);
				strReturn = new String(commonByteArray_SALESFORCETALEND_Read, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCETALEND_Read) {
	...
	public void tSalesforceInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tSalesforceInput_2", "TyNrau_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				s(currentComponent = "tBufferOutput_1");
				...
				sh("tSalesforceInput_2");

				s(currentComponent = "tSalesforceInput_2");

				int tos_count_tSalesforceInput_2 = 0;

				if (enableLogStash) {
					talendJobLog.addCM("tSalesforceInput_2", "tSalesforceInput_2", "tSalesforceInput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				@SuppressWarnings("unchecked")
				java.util.Map<String, Object> restRequest_tSalesforceInput_2 = (java.util.Map<String, Object>) globalMap
						.get("restRequest");
				String currentTRestRequestOperation_tSalesforceInput_2 = (String) (restRequest_tSalesforceInput_2 != null
						? restRequest_tSalesforceInput_2.get("OPERATION")
						: null);
				...
				props_tSalesforceInput_2.setValue("query",
						"SELECT Id, Name, ExternalID__c FROM Account WHERE Name = 'TestniAccount'");
				...
				props_tSalesforceInput_2.setValue("dataTimeUTC", true);
				...
				props_tSalesforceInput_2.module.setValue("moduleName", "Account");
				...
				props_tSalesforceInput_2.module.main.setValue("schema", new org.apache.avro.Schema.Parser()
						.setValidateDefaults(false).parse(sst_tSalesforceInput_2_1_fisrt.getSchemaValue()));
				...
				if (sourceOrSink_tSalesforceInput_2 instanceof org.talend.components.api.component.runtime.Source) {
					...
					for (; available_tSalesforceInput_2; available_tSalesforceInput_2 = reader_tSalesforceInput_2
						...
						try {
							...
							row1.Name = (String) (columnValue_1_tSalesforceInput_2);
							Object columnValue_2_tSalesforceInput_2 = outgoingEnforcer_tSalesforceInput_2.get(2);
							row1.ExternalID__c = (String) (columnValue_2_tSalesforceInput_2);
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tSalesforceInput_2", "tSalesforceInput_2", "tSalesforceInput",
								"tBufferOutput_1", "tBufferOutput_1", "tBufferOutput"
						...
						if (row1.Name != null) {
							...
							row_tBufferOutput_1[1] = row1.Name;

						} else {
							row_tBufferOutput_1[1] = null;
						}
						if (row1.ExternalID__c != null) {

							row_tBufferOutput_1[2] = row1.ExternalID__c;
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tSalesforceInput_2", "tSalesforceInput_2", "tSalesforceInput", "tBufferOutput_1",
						"tBufferOutput_1", "tBufferOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// finally of generic
	...
	public static void main(String[] args) {
		final Read ReadClass = new Read();

		int exitCode = ReadClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Read' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_79rLIPBTEe-SqKhbb-NjMQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-02-24T12:44:22.739564600Z");
		...
		try {
			...
			java.io.InputStream inContext = Read.class.getClassLoader()
					.getResourceAsStream("salesforcetalend/read_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Read.class.getClassLoader()
		...
		log.info("TalendJob: 'Read' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Read");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Read' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 93977 characters generated by Talend Cloud Data Management Platform on the
 * 24. veljače 2025. u 13:44:22 CET
 ************************************************************************************************/